	 ...
	 */
	 constructor(obj) {
		...
		setMethods.generateId = function(arg){			
			return vueApp ? this.$options.name + vueApp.generateId(arg) : this.$options.name + this.$root.generateId(arg);		
		}
...
var inputFields = new configComponent({
	...
	methods : {
		generateInputLabelId : function(arg){
			this.inputLabelId = vueApp ? this.$options.name + vueApp.generateId(arg) : this.$options.name + this.$root.generateId(arg);	
...
var preloaderCircleFull = new configComponent({
	...
	render : function (createElement) {
		var csection = this.newComponent(['c-section']).$mount().setStyleP(true).setColor(this.sectionColor);
		var ccontainer = this.newComponent(['c-container']).$mount().setStyleP(true).setContainer(false);
		var preloaderCircle = this.newComponent(['c-preloader-circle']).$mount().setColorHexa("red").setSize(this.size);
		csection.create(ccontainer);
